...
<body>
    ...
    $estudiantes = obtenerEstudiantes($conecta);
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-12">
                <h1 class="text-center">
                    ...
                    <a href="#" onclick="history.back()" class="btn btn-danger" title="Volver Atras"><i class="bi bi-arrow-return-left"></i></a>    
                    <a href="#" onclick="modalRegistrarEmpleado()" class="btn btn-success" title="Registrar Nuevo Estudiante">
                            <i class="bi bi-person-plus"></i>
                        </a>
                    </span>
                    Lista de Estudiantes (<?php echo $totalEstudiantes ?>)
                    <span class="float-end">
                        <a href="acciones/exportar.php" class="btn btn-success" title="Exportar a CSV" download="Estudiantes.csv"><i class="bi bi-filetype-csv"></i></a>
                    </span>
                    <hr>
                </h1>
                <?php
