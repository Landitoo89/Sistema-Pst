        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 titulo_modal">Actualizar Información Estudiante</h1>
                ...
                <div class="modal-body">
                    <form id="formularioEmpleadoEdit" action="" method="POST" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="mb-3 mt-4">
                            <label class="form-label">Foto actual del estudiante </label>
                            <br>
                            <img src"" id="avatar" style="display: block;" class="rounded-circle float-start" alt="Foto del estudiante" width="80">
                        </div>
                        <br> <br>

                        <div class="mb-3 mt-4">
                            <label class="form-label">Cambiar Foto del estudiante</label>
